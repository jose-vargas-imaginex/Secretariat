...
export const SCHEMA = `
  ...
  CREATE INDEX IF NOT EXISTS idx_blocks_daily_note ON blocks(daily_note_id);
  CREATE INDEX IF NOT EXISTS idx_entries_parent ON entries(parent_type, parent_id);
